...
void print_lsgt(Instruction instruction) {
    printf("lsgt\tx%d, x%d, x%d\n", instruction.rtype.rd, instruction.rtype.rs1, instruction.rtype.rs2);
}
